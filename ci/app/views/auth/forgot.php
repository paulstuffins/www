...
.lt-ie9 .login-button {
  line-height: 48px;
    ...
    <body>
        <form method="post" action="<?php echo site_url("auth/forgot"); ?>" class="login">
            <p><input type="text" name="login" id="login"  placeholder="Username" /></p>
            <p><input type="text" name="email" id="password" placeholder="Email Address" /></p>
            <p class="login-submit"><button type="submit" class="login-button">Reset Password</button></p>
            <p class="forgot-password"><a href="<?php echo site_url("auth/login"); ?>">Go back!</a></p>
        </form>
    </body>
</html>
